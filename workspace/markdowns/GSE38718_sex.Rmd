...
map_age <- function(age_category) {
  age_vector <- ifelse(age_category == "Women", 0,1)
...
col.status <- c("pink","blue")[batches]
...
de_a <- function(doc_name,ct) {
  ...
  col.status <- c("pink","blue","dark green")[batches]
