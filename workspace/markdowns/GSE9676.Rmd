...
```{r clean_up}
sample_data <- separate(sample_data, title, into = c("age_sex", "other"), sep = " yr ")
sample_data <- separate(sample_data, age_sex, into = c("sex", "age"), sep = " ")
...
Since this one has before and after enrichment, I will remove all the non control ones
```{r}
sample_data <- sample_data[sample_data$other == 'before antibody enrichment scan 1 (U133B)', ]
