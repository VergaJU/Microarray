...
if (length(gse) > 1) idx <- grep("GPL2700", attr(gse, "names")) else idx <- 1
gset <- gse[[idx]]
...
```{r clean_up}
sample_data <- separate(sample_data, characteristics_ch1.1, into = c("age", "nothing"), sep = " at onset of intervention")
sample_data <- separate(sample_data, age, into = c("nothing", "age"), sep = "Age: ")
```
