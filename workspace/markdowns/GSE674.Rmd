...
```{r clean_up}
sample_data <- separate(sample_data, source_name_ch1, into = c("muscle", "age_sex"), sep = " biopsy ")
sample_data <- separate(sample_data, age_sex, into = c("age", "sex"), sep = " yr old healthy ")
...
metadata_doc_name <- paste("samples_", my_id, extra, ".csv", sep = "")
expression_doc_name <- paste("expression_", my_id, extra, ".csv", sep = "")

assign_names <- function(c1, c2) {
  doc_name <- paste("DEG_list_", my_id, "_", c1, "_vs_", c2, extra, ".csv", sep = "")
  dds_doc_name <- paste("dds_", my_id, "_", c1[1], c2[1], extra, ".csv", sep = "")
